...
class LRUEvictionPolicy(EvictionPolicy):
    ...
    Attributes:
        ...
        _max_eviction_batch_size: Maximum number of keys to evict in one batch
    """

    def __init__(
        self,
        default_destination: EvictionDestination = EvictionDestination.DISCARD,
        max_eviction_batch_size: int = 100,
    ):
        """
        ...
        Args:
            default_destination: The default destination for evicted objects.
                Defaults to DISCARD.
            max_eviction_batch_size: Maximum number of keys to include in a
                single eviction action. Defaults to 100.
        """
        ...
        # Maximum batch size for eviction actions
        self._max_eviction_batch_size = max_eviction_batch_size
    ...
    def get_eviction_actions(self, expected_ratio: float) -> list[EvictionAction]:
        ...
        with self._lock:
            ...
            target_count = min(target_count, self._max_eviction_batch_size)
